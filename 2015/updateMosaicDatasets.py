...
# Example:  python UpdateMosaicDatasets.py c:/ERMES/PRODUCTS/IT_2015 foldersIT_2015.txt IT_2015.log
...
def updateMosaic(inputFolder, workspaceName, mosaicName):
    ...
    with arcpy.da.UpdateCursor(mosaicPath, fields) as cursor:
        for row in cursor:
    		...
    		parts =  rasterFileName.split("_")  # Ex: IT_Monitoring_NDVI_2015_001.tif
    		row[1] = parts[2]	# NDVI
    		row[2] = parts[3]	# 2015
    		day = int(parts[4])	# 001
